...
/*
This class contains the code for creating a Google Map and populating it with markers for available lots
 */
public class Map extends FragmentActivity implements OnMapReadyCallback,
    ...
    @Override
    /*
    Creates the acitivty. Gets intent from previous activity. Checks permissions. Schedules the JSON
    request code to run every 10 seconds.
...
* Gives markers info about the lot so on info window click the user is directed to payment activity
* @param address, city, state, spots, time, rate
 */
    ...
    @Override
    /*
    Runs once the map is ready. Defines code for infowindowClickListener. Checks Android build version.
    @param googleMap
     */
    ...
    @Override
    /*
    Runs once the network is connected. Requests user location.
    @param bundle
     */
    ...
    @Override
    /*
    Runs if network or GPS connection times out
    @param i
     */
    ...
    @Override
    /*
    Runs when user changes location. Adds marker to current location, moves camera to current location.
    ...
    @Override
    /*
    Called if connection not found
    ...
    /*
    Checks for all necessary location related permissions
    @return boolean value representing sufficient permissions have been granted to build API
     */
    ...
    @Override
    /*
    Called once permissions have been checked. Checks Manifest permissions.
    ...
    /*
    Gets address and lot info from database through JSON requests. Reformats and packages data as
    ArrayLists for call to addMarkers method.
    @param needsUpdate
     */
    ...
    /*
    Gets and returns distance as the crow flies between two points
    @param from, to
    @return distance
     */
