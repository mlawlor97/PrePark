...
/**
 * @author jawad
 * This class allows the user to select a parking spot when they try to buy a spot using the zip code in the 'Search Parking' section of the app.
 * This class sends an intent to the Map class.
 * Passes the username and the address.
 */
public class BuySpot extends AppCompatActivity {
    public ArrayList<String> gAddress = new ArrayList<>();

    /**
     * Creates the BuySpot activity
...
/**
 * When 'Find Parking' is pressed, it sends the zip to the database, search the database for the string.
 * Addresses belonging to that zip are returned in a list with the help of 'ListOfZip' class.
 * A progress dialog is also used
 */
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                ...
                                //Intent is sent to 'ListOfZip' class
                                //Puts all the addresses in a List
