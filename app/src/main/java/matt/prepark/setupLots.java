...
/**
 * This class contains the java code for the 'Setup Lots' section.
 * This takes in the address, zip, city, state, number of spots, maximum time and the rate of the parking lot.
 */
public class setupLots extends AppCompatActivity {
    /**
     * This method uses a NotificationManager object to send a notification to the user whenever it is called.
     */
    private void Notify(){
    ...
    /**
     * Creates the setupLots activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText et_zipSL = (EditText) findViewById(R.id.zip_setuplots);
        final EditText spotsSL = (EditText) findViewById(R.id.num_spots_setuplots);
        final EditText maxtimeSL = (EditText) findViewById(R.id.time_maxtime_setuplots);
        final EditText rateSL = (EditText) findViewById(R.id.rate_setuplots);
