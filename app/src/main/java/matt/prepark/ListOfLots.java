...
/*
Creates a scrollable list of currently availabke lots
 */
public class ListOfLots extends AppCompatActivity {
    ...
    @Override
    /*
    Creates the List activity. Gets intent from Map activity including information about the lots.
    Sets click listeners for list elements.
