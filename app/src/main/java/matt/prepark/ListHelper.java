...
/*
Helper class for the list of lots activity. Creates textview box on item element click
 */
public class ListHelper extends AppCompatActivity {

    @Override
    /*
    Creates the activity. Gets intent info from List class. Sends intent to payment screen if user chooses
    to purchase spot.
